...
namespace MyApp.BAL
{
    public static class UserService
    {
        public static CommonResponseDto<List<UserDto>> GetUserList()
        {
            ...
            var res = DBHelperDapper.GetAllModelList<UserDto>(_proc, queryparameter);
            response.Data = res;
            response.Flag = 1;
        ...
        public static CommonResponseDto<ValidationMessageDto> SaveUser(UserDto user)
        {
            ...
            var res = DBHelperDapper.GetAllModel<ValidationMessageDto>(_proc, queryparameter);
            response.Data = res;
        ...
        public static CommonResponseDto<UserDto> GetUser(string userguid)
        {
            ...
            var res = DBHelperDapper.GetAllModel<UserDto>(_proc, queryparameter);
            if (res != null)
            {
